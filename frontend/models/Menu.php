    ...
    $menu = RCEmenu::widget(
      [
        ...
        [
          ...
          ['label' => \Yii::t('app', 'RETOS'), 'icon' => 'cloud', 'url' => ['/network/default/index'], 'visible' => !Yii::$app->user->isGuest && Yii::$app->DisabledRoute->enabled('network/default/index'), 'active' => \Yii::$app->controller->module->id == "network"],
          ...
          ['label' => \Yii::t('app', 'Speed Programming'), 'icon' => '<i class="fas fa-laptop-code"></i>', 'url' => ['/speedprogramming/default/index'], 'visible' => !Yii::$app->user->isGuest && Yii::$app->DisabledRoute->enabled('speedprogramming/default/index')  && \Yii::$app->sys->module_speedprogramming_enabled===true, 'active' => \Yii::$app->controller->module->id == "speedprogramming"],
